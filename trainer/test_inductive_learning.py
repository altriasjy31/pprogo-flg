...
# test inductive learning with HGAT model
class HGAT_Trainer(object):
    ...
    def __init__(self, args):
        ...
        self.dataset = DBLPDataset('data', args['dataset_name'], 'HGAT_IL', args['batch_size'], self.device)
...
args = {'device':torch.device('cuda' if torch.cuda.is_available() else 'cpu'),
        'dataset_name': 'mf',
        'model_path':prj_root + '/models/hgat_IL' + '_mf',
        'epoch':10,
        'batch_size':16,
        'patience':10,
        'lr':0.01,
