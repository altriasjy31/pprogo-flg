...
class GIN(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_dim, num_hidden_layers, rel_names, learn_eps=False, aggregate='sum'):
        """_summary_
        ...
        Args:
            ...
            num_hidden_layers (int): _description_
            rel_names (list): The list of edge types of hg 
            learn_eps (Bool): If True, epsilon will be a learnable parameter. Default: False
            aggregate (str): Method for aggregating node features generated by different relations. Allowed string values are 'sum', 'max', 'min', 'mean', 'stack'. Default: 'sum'
        """
        ...
        self.fc1 = nn.ModuleDict({
            ...
            # for ntype in ntypes
            'protein': nn.Linear(input_dim, hidden_dim),
            'go_annotation': nn.Linear(output_dim, hidden_dim)
        })
    ...
    def forward(self, hg, h_dict):
        ...
        for ntype, feat in h_dict.items():
                h_dict[ntype] = self.drop(self.fc1[ntype](feat.float()))
